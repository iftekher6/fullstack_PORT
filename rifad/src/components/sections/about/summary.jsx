...
import arrow from '../../../assets/images/arrow-bar-right.svg'
import { Link } from 'react-router-dom'
import { RiArrowRightLine, RiArrowRightCircleLine} from '@remixicon/react'
                ...
                <div className="container-inner">
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-7 ">
                            ...
                            <Link to={'/about'} ><button className='theme-btn about'>more
                                    <RiArrowRightCircleLine color='rgb(196, 240, 0)'  size={19}></RiArrowRightCircleLine>
                                    </button></Link>
                        </div>
